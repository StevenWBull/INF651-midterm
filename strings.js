...
console.log(`truncateString('Hello, World!', 5) should be 'Hello...': ${truncateString(string, 5)}`);
console.log(`truncateString('Hello, World!', 20) should be 'Hello, World!': ${truncateString(string, 20)}`);
console.log(`truncateString('Hello, World!', 8) should be 'Hello, W...': ${truncateString(string, 8)}`);